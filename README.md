...
**Full-Stack Software Developer** · Madrid, Spain · React Native · Node.js · TypeScript

I build secure, maintainable and scalable cross-platform mobile and web applications. Currently **Software Developer II at Inception Fertility** (healthtech), working across the stack — React Native apps, Node.js backends, and secure authentication. I come from a background in finance and economics, which gives me a product- and business-aware view of engineering, and I integrate AI agents and LLMs into real development workflows.

### 🛠️ Tech
- **Languages:** TypeScript, JavaScript, Java, Python, SQL
- **Frontend / Mobile:** React, React Native, Next.js, Expo, Tailwind CSS
- **Backend:** Node.js, NestJS, Express, Spring Boot, REST APIs, GraphQL
- **Data:** PostgreSQL, MongoDB, Supabase
- **Cloud / DevOps:** AWS, Azure, Vercel, Docker, Kubernetes, Git, CI/CD
- **Applied AI:** LLM integration, agent orchestration, AI-assisted development workflows
...
- Email: cfelipecruzp@outlook.com
